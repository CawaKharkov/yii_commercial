					...
					<div class="carousel-inner">
						<div class="item active">
							<div class="col-sm-6 col-md-3" >
								<div class="new-class" >
									<img src="img/classes/01.jpg" alt="//" />
			...
			<div class="container" >
				...
				<div class="row" >
					<div class="col-xs-3 col-sm-2 col-md-1" >
						<img src="img/featured-classes/ballet.png" alt="//" />
					</div>
					...
					<div class="col-xs-3 col-sm-2 col-md-1" >
						<img src="img/featured-classes/yoga.png" alt="//" />
					</div>
					<div class="col-xs-9 col-sm-10 col-md-3 fc-container" >
						<h3>Yoga classes</h3>
						<p>
					...
					<div class="col-xs-3 col-sm-2 col-md-1" >
						<img src="img/featured-classes/karate.png" alt="//" />
					</div>
					<div class="col-xs-9 col-sm-10 col-md-3 fc-container" >
