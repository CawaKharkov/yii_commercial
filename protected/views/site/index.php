	...
	<section id="home" >
			...
			<div class="banner ">
				<ul>                        
					<li 
						...
						data-slotamount="1"
					>
						<img src="/resources/frontend/img/slider/01.jpg" alt="//" />
						<div 
					...
					<li 
						...
						data-slotamount="1"
					>
						<img src="/resources/frontend/img/slider/02.jpg" alt="//" />
						<div 
					...
					<li 
						...
						data-slotamount="1"
					>
						<img src="/resources/frontend/img/slider/04.jpg" alt="//" />
						<div 
							class="caption lfb ltb"  
							data-x="100" 
							data-y="95" 
					...
					<li 
						...
						data-slotamount="1"
					>
						<img src="/resources/frontend/img/slider/05.jpg" alt="//" />
						<div 
							class="caption lfb ltb" 
							data-x="600"
							data-y="120"
					...
					<li 
						...
						data-slotamount="1"
					>
						<img src="/resources/frontend/img/slider/06.jpg" alt="//" />
						<div 
							class="caption lfb ltb divA"  
							data-x="100" 
							data-y="bottom" 
		...
		<article class="article-container">
			<div class="container" >
				...
				<div class="row">
					...
					<div id="new-classes" class="carousel slider">
					<!-- Wrapper for slides -->
					<div class="carousel-inner">
						<div class="item active">
							<div class="col-sm-6 col-md-3" >
								<div class="new-class" >
									<img src="/resources/frontend/img/classes/01.jpg" alt="//" />
			...
			<div class="container" >
				...
				<div class="row" >
					<div class="col-xs-3 col-sm-2 col-md-1" >
						<img src="/resources/frontend/img/featured-classes/ballet-green.png" alt="//" />
					</div>
					...
					<div class="col-xs-3 col-sm-2 col-md-1" >
						<img src="/resources/frontend/img/featured-classes/yoga-green.png" alt="//" />
					</div>
					<div class="col-xs-9 col-sm-10 col-md-3 fc-container" >
						<h3>Yoga classes</h3>
						<p>
					...
					<div class="col-xs-3 col-sm-2 col-md-1" >
						<img src="/resources/frontend/img/featured-classes/karate-green.png" alt="//" />
					</div>
					<div class="col-xs-9 col-sm-10 col-md-3 fc-container" >
		...
		<article class="article-container">
			<div class="container" >
				...
				<div class="row" >
					<div id="bodybuilding" class="carousel slider">
					<!-- Wrapper for slides -->
					<div class="carousel-inner">
						<div class="item active">
							<ul class="logos" >
								<li><a href="#"><img src="/resources/frontend/img/logos/1.png" alt="//" /></a></li>
								<li><a href="#"><img src="/resources/frontend/img/logos/2.png" alt="//" /></a></li>
								<li><a href="#"><img src="/resources/frontend/img/logos/3.png" alt="//" /></a></li>
								<li><a href="#"><img src="/resources/frontend/img/logos/4.png" alt="//" /></a></li>
								<li><a href="#"><img src="/resources/frontend/img/logos/5.png" alt="//" /></a></li>
							</ul>
						</div>
						<div class="item">
							<ul class="logos" >
